...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6">
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[600px] h-[600px] rounded-full bg-purple-700/20 blur-[140px] pointer-events-none" />
      <div className="text-center fade-up">
        ...
        <p className="h-8 font-mono text-lg md:text-xl text-white/70">
          {text}
