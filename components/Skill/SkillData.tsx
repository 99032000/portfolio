...
import { AiFillGithub, AiFillTool } from "react-icons/ai";
...
const languageSet: skillInterface[] = [
  {
    name: "Javascript",
    icon: (
      <svg
...
const frontendSet: skillInterface[] = [
  {
    name: "ReactJs",
    icon: (
...
const backendSet: skillInterface[] = [
  {
    name: "NodeJs",
    icon: (
...
export const SkillData: skillsInterface[] = [
  {
    category: "All",
    skills: [
      ...languageSet,
